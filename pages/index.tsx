...
//   },
// ];
export interface ProductI{products:ProductsAPIResponse }
const Home: NextPage<ProductI> = ({products}) => {
...
export const getServerSideProps = async () => {
  const res = await fetch(`https://tiendalibre.vercel.app/api/products`);
